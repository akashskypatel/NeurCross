...
def test_generate_label_writes_manifest(tmp_path):
    ...
    assert (sample_dir / "features" / "edges_unique.npy").exists()
    assert (sample_dir / "features" / "edge_sharpness.npy").exists()
    assert (sample_dir / "features" / "edge_dihedral_degrees.npy").exists()
    assert (sample_dir / "features" / "edge_is_boundary.npy").exists()
    assert (sample_dir / "features" / "salient_edge_mask.npy").exists()
    assert (sample_dir / "features" / "structure_edge_labels.npy").exists()
    assert (sample_dir / "features" / "structure_lines.json").exists()
    assert (sample_dir / "features" / "structure_quality_metrics.json").exists()
