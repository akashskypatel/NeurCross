...
```
coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-central1 || coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-east1 || coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-east4 || coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-west1 || coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-west2 || coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-west3 || coiled notebook start --vm-type g2-standard-4 --software neurcross --name neurcross_training --open --region us-west4
```
